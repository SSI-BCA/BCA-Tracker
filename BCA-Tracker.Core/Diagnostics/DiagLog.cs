...
{
    /// <summary>
    /// Centralised diagnostic logger. One file per session, written to BCA-Tracker\diag.log.
    ...
    public static class DiagLog
    {
        ...
        public static void Init()
        {
            ...
            Write($"═══ BCA-Tracker diagnostic session {_sessionStart:yyyy-MM-dd HH:mm:ss} ═══");
        }
